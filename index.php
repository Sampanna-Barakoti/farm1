        ...
        <div id="mega-slider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active beactive">
                    <img src="img/brand/brand1.jpeg" alt="brand1.jpg" style="width: 100%; height: 3%;">
                    <div class="carousel-caption">
                        <h2>Welcome to Crop Auction</h2>
                    </div>
                </div>
                <div class="item">
                    <img src="img/brand/qwer.png" alt="qwer.png" style="width: 100%; height: 3%;">
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/brand/brand3.jpg" alt="brand3.jpg" style="width: 100%; height: 3%;">
                    <div class="carousel-caption">
                        <h2>BID The crop</h2>
                ...
                <div class="item">
                    <img src="img/brand/brand4.png" alt="brand4.png" style="width: 100%; height: 3%;">
                    <div class="carousel-caption">
                                ...
                                <div class="products grid-product">
                                    <div class="product-grid-inner">
                                        ...
                                        <div class="product-grid-caption text-center">
                                            ...
                                            ?>
                                            <h5>Bid Price:<strong><?= $bidPrice ?></strong> RS</h5>
                                        ...
                                        <div class="products grid-product">
                                            <div class="product-grid-inner">
                                                ...
                                                <div class="product-grid-caption text-center">
                                                    ...
                                                    <h5>Bid Price:Rs <strong><?= $maxprice ?></strong></h5>
                                                    <div class="pro-size"><label>Type: <span><?= $type ?></span> </label>
                                                        <div><label>Catagory: <span><?= $catagory ?></span> </label></div>
                                                    </div>
